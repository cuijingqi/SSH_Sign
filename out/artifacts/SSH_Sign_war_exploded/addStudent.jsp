...
<div class="container-fluid" id="world">
    <div class="row">
        ...
        <div class="col-md-6 col-sm-6 col-xs-8"><div class="page-header"><h1><small>添加学生</small></h1></div></div>
