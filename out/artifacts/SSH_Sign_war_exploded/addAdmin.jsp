        ...
        function sub() {
            if (validity()){
                ...
                $.ajax({
                    ...
                    data: {competence:${pageContext.session.getAttribute("admin").AId},
                        name:name,
                        userName:userName,
                        password:password,
                        email:email,
                    ...
                    success: function (data) {
                        if (data=="win"){
                            ...
                            $("#myAlert").html("<div class=\"alert alert-warning\">\n" +
                                "                <a href=\"#\" class=\"close\" data-dismiss=\"alert\">&times;</a>\n" +
                                "                <strong>失败</strong> 管理员不存在!<a href='${pageContext.request.contextPath}/Admin.jsp'>重新登录</a>\n" +
                                "            </div>")
                        } else {
...
<div class="container-fluid" id="world">
    <div class="row">
        ...
        <div class="col-md-6 col-sm-6 col-xs-8"><div class="page-header"><h1><small>添加子管理员</small></h1></div></div>
