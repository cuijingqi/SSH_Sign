...
<div class="container-fluid" id="world">
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-sm-6 col-xs-8">
            <ul class="nav nav-tabs">
                <li role="presentation" class="active"><a href="Admin.jsp">登录</a></li>
                <li role="presentation"><a href="">忘记密码</a></li>
            </ul>
        </div>
    ...
    <form id="submit" action="Admin/Login" method="post" class="form-horizontal">
        ...
        <div id="two" class="form-group">
            ...
            <div class="col-sm-2 col-md-3 col-xs-5">
                <input type="password" required="required" class="form-control" id="password" name="password" minlength="8" maxlength="25" placeholder="Password">
            </div>
            <div class="col-md-0 col-sm-0 col-xs-4"></div>
            <div class="clearfix visible-xs-block"></div>
            <div class="col-md-0 col-sm-0 col-xs-3"></div>
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-xs-offset-1 col-sm-10">
                <button id="btns"  type="submit" class="btn btn-default">登录</button>
            </div>
        </div>
    </form>
    <div class="form-group">
